...
class Application_Model_DbTable_Estudiantes extends Zend_Db_Table_Abstract {
    ...
    protected $_name = 'hk_estudiantes';     
    public function getEstudiante($id) {
        $select = $this->select()
                        ->from(array('e'  => 'hk_estudiantes'),array('id','cedula' ,'nombre','apellido','direccion','tlf','grado','profesion','estado','ciudad','fecha_nac'=>'DATE_FORMAT(fecha_nac, "%d-%m-%Y")','foto','email'))  
                        ->where('id = ?', $id);
    ...
    public function addEstudiante($data = array()) {
        $rs = $this->insert($data);
        return $rs;
    }
    
    public function updateEstudiante($id, $data = array()) {
