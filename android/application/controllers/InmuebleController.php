    ...
    public function listAction(){
     ...
     public function addAction(){
        ...
        if ($this->getRequest()->isPost()) {
                ...
                $this->_redirect('/areacliente/mispropiedades');           
        }
...
public function detalleAction() {
    ...
    $auth = Zend_Auth::getInstance();
        ...
        $pdf->Image('assets/img/4c77e08c8a55e39bdf2e05fcf1c8912e.png',10,10,50,20);
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td align="center" st-image="banner-image">
                                    <div class="imgpop">
                                       <a target="_blank" href="pgmbienesraices.com"><img  border="0" height="200" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="http://pgmbienesraices.com/assets/diseno/archivos/procesados/pgm.jpg" class="banner"></a>
                                    </div>
                                 </td>
                              </tr>
                           </tbody>
                                 ...
                                 <td>
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             <td width="100%" align="center" class="devicewidth">
                                                <img src="http://pgmbienesraices.com/assets/img/c5d0b349ad96a8fb077173b3ef9a9917.jpg" alt="" border="0" width="100" height="100" style="display:block; border:none; outline:none; text-decoration:none;">
                                             </td>
                                          </tr>
                                          <!-- end of image2 -->
                                          <tr>
                                                   ...
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         <td style="font-family: \'Open Sans\', sans-serif; font-weight: 700; font-size: 18px; color: #146eb4      ; text-align:center; line-height: 24px;" st-title="3col-title1">
                                                            <a href="http://pgmbienesraices.com/"> INMUEBLES SELECCIONADOS </a>
                                                         </td>
                                                      </tr>
                                                      <!-- end of title2 -->
                                                      <!-- Spacing -->
                                    ...
                                    <table width="186" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                       <tbody>
                                          ...
                                          <tr>
                                             <td width="100%" align="center" class="devicewidth">
                                                <img src="http://pgmbienesraices.com/assets/img/0d8553cbc61043799a64e3c941d6c8ea.jpg" alt="" border="0" width="100" height="100" style="display:block; border:none; outline:none; text-decoration:none;">
                                             </td>
                                          </tr>
                                          <!-- end of image2 -->
                                          <tr>
                                                   ...
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         <td style="font-family: \'Open Sans\', sans-serif; font-size: 14px; color: #889098; text-align:center; line-height: 24px;" st-content="3col-content2">
                                                            Una vez que encuentres el inmueble adecuado, PGM te proporcionar� la informacion de contacto necesaria para que te comuniques con el agente inmobiliario, ya sea v�a email o por telefono
                                                         </td>
                                                      </tr>
                                                      <!-- end of content2 -->
                                                      <!-- Spacing -->
                                    ...
                                    <table width="186" align="right" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                       <tbody>
                                          ...
                                          <tr>
                                             <td width="100%" align="center" class="devicewidth">
                                                <img src="http://pgmbienesraices.com/assets/img/5ccb0fb326273314226926deec4de257.jpg" alt="" border="0" width="100" height="100" style="display:block; border:none; outline:none; text-decoration:none;">
                                             </td>
                                          </tr>
                                          <!-- end of image3 -->
                                          <tr>
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             <td  align="center" class="devicewidth">
                                                   <img src="http://pgmbienesraices.com/assets/diseno/archivos/procesados/logo.png" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" class="colimg2">
                                             </td>
                  ...
                  <td style="width: 35%;"></td><td style="width: 15%;"></td>
                     ...
                     <td align="center" height="50" style="font-size:12px; line-height:1px; text-align: left;">
                              ...
                              <a target="_blank" href="http://www.maymi.com.ve">
                                 <img src="http://www.pgmbienesraices.com/assets/img/logo_maymi.png" alt="" height="20" border="0" style="display:block; border:none; outline:none; text-decoration:none;" class="colimg2">
                              </a>                 
...
<!-- End of seperator -->  
                   ...
                   $headers .= "From: Pgm Bienes Raices  <info@pgmbienesraices.com>\r\n"; 
