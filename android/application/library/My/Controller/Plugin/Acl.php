...
class My_Controller_Plugin_Acl extends Zend_Controller_Plugin_Abstract {
    ...
    public function preDispatch(Zend_Controller_Request_Abstract $request) {
        ...
        if (!$auth->hasIdentity() && !in_array($resource, array('ajax', 'index', 'nosotros', 'contacto', 'servicios', 'portafolio', 'inmueble', 'blog', 'asesores', 'registro', 'login', 'olvide')) && !in_array($privilege, array('index', 'ver', 'buscar', 'tags', 'codigo', 'reinicar'))) {
