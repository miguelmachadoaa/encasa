...
class Application_Model_DbTable_Clientes extends Zend_Db_Table_Abstract {
    ...
    public function getCliente($id) {
        $select = $this->select()
                        ->from(array('e'  => 'hk_clientes'),array('id','cedula' ,'nombre','direccion','tlf','estado','fecha_nac'=>'DATE_FORMAT(fecha_nac, "%d/%m/%Y")','email'))  
                        ->where('id = ?', $id);
    ...
    public function getClientes($options = array()) {
        ...
        $select = $this->select()
             ->from(array('e'  => 'hk_clientes'),array('id','cedula' ,'nombre','email','direccion','tlf','estado', 'fecha_nac'=>'DATE_FORMAT(fecha_nac, "%d/%m/%Y")'))  
