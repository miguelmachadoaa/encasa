...
class DirectorioController extends Zend_Controller_Action {
    ...
    public function init() {
     ...
     public function indexAction(){
        ...
        $this->view->pagina = $ObjPaginas->fetchRow('grupo="asesores"');
       ...
       $Obj= new Application_Model_DbTable_Users();
        ...
        $this->view->elementos = $Obj->getUsuarios();
       ...
       # $this->view->noticias = $ObjNoticias->Aleatorio();
        ...
        $meta = array(
            'titulo' => 'Directorio - En Casa Plus', 
            'descripcion' => '', 
            'imagen' => '',
            'url'=>''
            );
