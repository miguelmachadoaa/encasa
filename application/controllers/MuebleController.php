...
class MuebleController extends Zend_Controller_Action {
    ...
    public function indexAction(){
       ...
       $ObjMueble= new Application_Model_DbTable_Mueble();
        ...
        $this->view->muebles = $ObjMueble->fetchAll();
    ...
    public function verAction(){
        ...
        $this->view->presupuesto = $ObjMueble->get($id);

        $ObjBienes= new Application_Model_DbTable_Bienes();

        $this->view->bienes = $ObjBienes->getBienes($id);
